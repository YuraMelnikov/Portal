...
function loadData() {
    $("#myTable").DataTable({
        ...
        "columns": [
            ...
            { "title": "Требуемая дата поставки", "data": "DateSupply", "autowidth": true, "bSortable": false, "className": 'text-center' },
            { "title": "Требуемая дата отгрузки", "data": "DateShipping", "autowidth": true, "bSortable": false, "className": 'text-center' },
