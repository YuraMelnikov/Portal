...
function loadData() {
    $.ajax({
        url: "/Service_TypeReclamationDocument/List",
        type: "GET",
...
function Add() {
    ...
    $.ajax({
        url: "/Service_TypeReclamationDocument/Add",
...
function getbyID(id) {
    ...
    $.ajax({
        url: "/Service_TypeReclamationDocument/getbyID/" + id,
        typr: "GET",
        contentType: "application/json;charset=UTF-8",
        dataType: "json",
        success: function (result) {
...
function Update() {
    ...
    $.ajax({
        url: "/Service_TypeReclamationDocument/Update",
        data: JSON.stringify(typeObj),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
