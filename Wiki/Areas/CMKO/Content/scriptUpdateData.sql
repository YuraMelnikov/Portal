...
delete PortalKATEK.dbo.CMKO_RemarksList where PortalKATEK.dbo.CMKO_RemarksList.rowNum != 1
...
delete [PortalKATEK].[dbo].[CMKO_RemarksList]
FROM [PortalKATEK].[dbo].[CMKO_RemarksList] left join [PortalKATEK].[dbo].[CMKO_RemarksListG] on PortalKATEK.dbo.CMKO_RemarksListG.id_Reclamation = PortalKATEK.dbo.CMKO_RemarksList.id_Reclamation
where [PortalKATEK].[dbo].[CMKO_RemarksListG].id is not null and ([PortalKATEK].[dbo].[CMKO_RemarksList].id_AspNetUsers = [PortalKATEK].[dbo].[CMKO_RemarksListG].id_AspNetUsers)
...
,(max(Overflows.SumKBM) * @coenBujetNManager) + sum(PortalKATEK.dbo.CMKO_BujetList.accruedManagerForTaskKBM) + sum(PortalKATEK.dbo.CMKO_BujetList.accruedManagerForNTaskKBM) as wageFundOverflowsManagerMPlan
,(max(Overflows.SumKBM) * @coenBujetNManager) + sum(iif(PortalKATEK.dbo.CMKO_BujetList.TaskPercentCompleted = 100, PortalKATEK.dbo.CMKO_BujetList.accruedManagerForTaskKBM, 0)) + sum(iif(PortalKATEK.dbo.CMKO_BujetList.TaskPercentCompleted = 100, PortalKATEK.dbo.CMKO_BujetList.accruedManagerForNTaskKBM, 0)) as wageFundOverflowsManagerMFact
,(max(Overflows.SumKBE) * @coenBujetNManager) + sum(PortalKATEK.dbo.CMKO_BujetList.accruedManagerForTaskKBE) + sum(PortalKATEK.dbo.CMKO_BujetList.accruedManagerForNTaskKBE) as wageFundOverflowsManagerEPlan
,(max(Overflows.SumKBE) * @coenBujetNManager) + sum(iif(PortalKATEK.dbo.CMKO_BujetList.TaskPercentCompleted = 100, PortalKATEK.dbo.CMKO_BujetList.accruedManagerForTaskKBE, 0)) + sum(iif(PortalKATEK.dbo.CMKO_BujetList.TaskPercentCompleted = 100, PortalKATEK.dbo.CMKO_BujetList.accruedManagerForNTaskKBE, 0)) as wageFundOverflowsManagerEFact
...
left join (select TableRes.id_AspNetUsersError as id_AspNetUsersError
                ...
                from (select PortalKATEK.dbo.CMKO_RemarksList.id_AspNetUsers
						,PortalKATEK.dbo.Reclamation_CountError.[count] as countError
						,0 as countErrorG 
						,PortalKATEK.dbo.CMKO_RemarksList.rowNum
...
select 
PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.id_AspNetUsers
,(PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan]) as [accruedPlan]
,(PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact]) as [accruedFact]
,((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan])) - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan])) * (PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefError * PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefManager)) as [withheldPlan]
,((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact])) - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact])) * (PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefError * PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefManager)) as [withheldFact]
,((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan]))
  - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan])) - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhPlan / TableNh.sumNhPlan) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMPlan], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEPlan])) * (PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefError * PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefManager))) as [accruedTotalPlan]
,((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact]))
  - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact])) - (((PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.nhFact / TableNh.sumNhFact) *  iif(SUBSTRING(PortalKATEK.dbo.Devision.[name], 0, 4) like '%КБМ%', [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerMFact], [PortalKATEK].[dbo].[CMKO_ThisWageFund].[wageFundOverflowsWorkerEFact])) * (PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefError * PortalKATEK.dbo.CMKO_ThisIndicatorsUsers.coefManager))) as [accruedTotalFact]
,0 as [bonusPlan]
,0 as [bonusFact]
from
