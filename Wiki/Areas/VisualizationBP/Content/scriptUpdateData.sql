...
PortalKatek.dbo.PZ_TEO.Rate / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS RateHoure,
PortalKatek.dbo.PZ_TEO.SSM / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS ssmHoure, 
iif(exportImport.dbo.planZakaz.SSfact is null, 0, exportImport.dbo.planZakaz.SSfact) / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS ssmFactHoure,
PortalKatek.dbo.PZ_TEO.SSR / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS ssrHoure, 
PortalKatek.dbo.PZ_TEO.IzdKom / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS ikHoure, 
PortalKatek.dbo.PZ_TEO.IzdPPKredit / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS ppkHoure, 
PortalKatek.dbo.PZ_TEO.PI / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS piHoure, 
PortalKatek.dbo.PZ_TEO.NOP / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] AS nopHoure, 
PortalKatek.dbo.PZ_TEO.Rate / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xRate, 
PortalKatek.dbo.PZ_TEO.SSM / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xSSM, 
iif(exportImport.dbo.planZakaz.SSfact is null, 0, exportImport.dbo.planZakaz.SSfact) / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xSSMFact, 
PortalKatek.dbo.PZ_TEO.SSR / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xSSR, 
PortalKatek.dbo.PZ_TEO.IzdKom / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xIK, 
PortalKatek.dbo.PZ_TEO.IzdPPKredit / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xPPK, 
PortalKatek.dbo.PZ_TEO.PI / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xPI, 
PortalKatek.dbo.PZ_TEO.NOP / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xNOP
...
FROM         ProjectWebApp.dbo.MSP_EpmProject_UserView INNER JOIN
                      ...
                      PortalKatek.dbo.PZ_PlanZakaz ON CONVERT(varchar, PortalKatek.dbo.PZ_PlanZakaz.PlanZakaz) = ProjectWebApp.dbo.MSP_EpmProject_UserView.[¹ çàêàçà] LEFT OUTER JOIN
                      ...
                      ReportKATEK.dbo.ProjectWorkPO ON ReportKATEK.dbo.ProjectWorkPO.[¹ çàêàçà] = ProjectWebApp.dbo.MSP_EpmProject_UserView.[¹ çàêàçà] left join
					  [PortalKATEK].[dbo].[DashboardBP_State] on [PortalKATEK].[dbo].[DashboardBP_State].id > 0
WHERE     
[PortalKATEK].[dbo].[DashboardBP_State].active = 1
and
(ProjectWebApp.dbo.MSP_EpmProject_UserView.[¹ çàêàçà] NOT LIKE '%ÍÈÎÊĞ%') AND 
                      (ProjectWebApp.dbo.MSP_EpmProject_UserView.[¹ çàêàçà] NOT LIKE '%Çàäàí%') AND 
                      (ProjectWebApp.dbo.MSP_EpmProject_UserView.[¹ çàêàçà] NOT LIKE '%Ïğî÷%') AND (ProjectWebApp.dbo.MSP_EpmProject_UserView.[Êîë-âî ÏÎ] > 0) AND 
                      (ProjectWebApp.dbo.MSP_EpmResource_UserView.ÑÄĞåñ LIKE '%ÓÑ%' OR
                      ProjectWebApp.dbo.MSP_EpmResource_UserView.ÑÄĞåñ LIKE '%ÓÈ%' OR
                      ProjectWebApp.dbo.MSP_EpmResource_UserView.ÑÄĞåñ LIKE '%İÓ%') AND (ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork > 0)
...
SELECT
  ...
  ,PortalKATEK.dbo.PWA_TasksForBP.ÍÊ
