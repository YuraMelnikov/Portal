...
PortalKatek.dbo.PZ_TEO.Rate / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS RateHoure,
PortalKatek.dbo.PZ_TEO.SSM / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS ssmHoure, 
iif(exportImport.dbo.planZakaz.SSfact is null, 0, exportImport.dbo.planZakaz.SSfact) / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS ssmFactHoure,
PortalKatek.dbo.PZ_TEO.SSR / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS ssrHoure, 
PortalKatek.dbo.PZ_TEO.IzdKom / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS ikHoure, 
PortalKatek.dbo.PZ_TEO.IzdPPKredit / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS ppkHoure, 
PortalKatek.dbo.PZ_TEO.PI / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS piHoure, 
PortalKatek.dbo.PZ_TEO.NOP / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] AS nopHoure, 
PortalKatek.dbo.PZ_TEO.Rate / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xRate
,iif(convert(int, isnull(TableWorkKBM.[close], 1)) + convert(int, isnull(TableWorkKBE.[close], 1)) = 2, PortalKatek.dbo.PZ_TEO.SSM / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork, 0) AS xSSM, 
iif(exportImport.dbo.planZakaz.SSfact is null, 0, exportImport.dbo.planZakaz.SSfact) / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xSSMFact, 
PortalKatek.dbo.PZ_TEO.SSR / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xSSR, 
PortalKatek.dbo.PZ_TEO.IzdKom / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xIK, 
PortalKatek.dbo.PZ_TEO.IzdPPKredit / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xPPK, 
PortalKatek.dbo.PZ_TEO.PI / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xPI, 
PortalKatek.dbo.PZ_TEO.NOP / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork AS xNOP
...
,iif(convert(int, isnull(TableWorkKBM.[close], 1)) + convert(int, isnull(TableWorkKBE.[close], 1)) != 2, PortalKatek.dbo.PZ_TEO.SSM / ReportKATEK.dbo.ProjectWorkPO.AssignmentWork * ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] * ProjectWebApp.dbo.MSP_EpmAssignmentByDay_UserView.AssignmentWork, 0) as [xHSSNoplaningwork]
...
PortalKatek.dbo.PZ_PlanZakaz ON CONVERT(varchar, PortalKatek.dbo.PZ_PlanZakaz.PlanZakaz) = ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] LEFT OUTER JOIN
...
ReportKATEK.dbo.ProjectWorkPO ON ReportKATEK.dbo.ProjectWorkPO.[π Á‡Í‡Á‡] = ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] left join
...
AND (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] NOT LIKE '%Õ»Œ –%') 
AND (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] NOT LIKE '%«‡‰‡Ì%') 
AND (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] NOT LIKE '%œÓ˜%') 
AND (ProjectWebApp.dbo.MSP_EpmProject_UserView.[ ÓÎ-‚Ó œŒ] > 0) 
AND (ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”—%' 
		OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”»%' 
		OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%›”%') 
...
,PortalKATEK.dbo.PWA_TasksForBP.Õ 
...
select
[ProjectWebApp].[dbo].[MSP_EpmTask_UserView].TaskUID
,[ProjectWebApp].[dbo].[MSP_EpmProject_UserView].[π Á‡Í‡Á‡]
,[ProjectWebApp].[dbo].[MSP_EpmTask_UserView].TaskName
,[ProjectWebApp].[dbo].[MSP_EpmResource_UserView].ResourceName
,0
,0
,[ReportKATEK].[dbo].RTF2Text(convert(varchar(max),convert(varbinary(max),[TASK_RTF_NOTES]))) AS [œËÏ.]
...
and [ProjectWebApp].[dbo].[MSP_EpmProject_UserView].[π Á‡Í‡Á‡] not like '%«‡‰‡ÌËÂ%'
and [ProjectWebApp].[dbo].[MSP_EpmProject_UserView].[π Á‡Í‡Á‡] not like '%œÓ˜ËÂ%'
and [ProjectWebApp].[dbo].[MSP_EpmProject_UserView].[π Á‡Í‡Á‡] not like '%Õ»Œ –%'
and (ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”—–%'
OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”»ÿ%'
OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”—Ã %'
OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%”——%'
OR ProjectWebApp.dbo.MSP_EpmResource_UserView.—ƒ–ÂÒ LIKE '%›”%')
...
left join [exportImport].[dbo].[planZakaz] on exportImport.dbo.planZakaz.Zakaz = ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡]
...
and (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] is not null)
and (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] not like '%«‡‰‡ÌË%')
and (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] not like '%Õ»Œ –%')
and (ProjectWebApp.dbo.MSP_EpmProject_UserView.[π Á‡Í‡Á‡] not like '%œÓ˜Ë%')
