...
--left join (select * from ProjectWebApp.dbo.MSP_EpmResource_UserView where ProjectWebApp.dbo.MSP_EpmResource_UserView.СДРес like '%УС%' or ProjectWebApp.dbo.MSP_EpmResource_UserView.СДРес like '%УИШ%' or ProjectWebApp.dbo.MSP_EpmResource_UserView.СДРес like '%ЭУ%') as TableResource on TableResource.ResourceUID is not null
