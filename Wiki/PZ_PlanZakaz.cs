...
namespace Wiki
{
    ...
    public partial class PZ_PlanZakaz
    {
        ...
        public PZ_PlanZakaz()
        {
            ...
            this.CrossOrder = new HashSet<CrossOrder>();
            this.CrossOrder1 = new HashSet<CrossOrder>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<CrossOrder> CrossOrder { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<CrossOrder> CrossOrder1 { get; set; }
    }
}
